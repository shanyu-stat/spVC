...
path.data <- "/Users/sy5jx/Dropbox/Research/Papers/Collaboration/SingleCellData/Code/numeric_results/application/Cortex-10x/data/"
...
results <- test.spVC(Y = Y, X, S, V, Tr, para.cores = 1,
                     subset = 1:1000)
# save(results, file = "Cortex-10x.RData")
